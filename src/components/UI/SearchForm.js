...
//TODO create a button component and make the svg clear the input field
    ...
    render () {
        return (
            <form className="search-form" onSubmit={this.handleSubmit}>
                <input type="search" name="search" placeholder="Search" onChange={this.updateInputValue} value={this.state.searchInputValue} required ref={ (input) => this.query = input}/>
